...
Development relay for connecting a CodeP desktop app to mobile clients.
...
curl -H 'X-CodeP-Admin-Token: change-me' http://127.0.0.1:8787/api/devices
```

For LAN testing, use the workstation IP from the phone browser, for example:

```text
http://192.168.1.20:8787/healthz
```
